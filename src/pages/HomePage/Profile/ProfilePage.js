    ...
    if (result) {
        return (
            <div className="bg-gradient-to-r from-black-1 via-purple-3 to-purple-2 h-screen">
                ...
                <div className="">
                    <div className="absolute left-2/4 top-2/4 transform -translate-x-2/4 -translate-y-2/4 w-screen grid grid-cols-1 md:grid-cols-2 gap-2 p-4 bg-white bg-opacity-10 shadow-xl rounded-md backdrop-filter backdrop-blur-md border-white border-t-2 border-l-2">
                        {/* User basic info */}
                        <div className="flex flex-col justify-center items-center bg-blue-2 row-span-2 bg-white shadow-2xl rounded-md p-2">
                            ...
                            <button className="text-center rounded-md bg-purple-2 text-blue-1 py-2 w-32 mx-auto font-bold hover:text-white">Sửa tài khoản</button>
                        </div>
                        {/* User details */}
